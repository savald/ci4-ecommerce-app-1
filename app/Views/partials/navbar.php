      ...
      <li class="nav-item ms-4">
        <div class="dropdown ">
          ...
          <ul class="dropdown-menu dropdown-menu-end" style="width:  400px; overflow-x: hidden;">
            ...
            <li class="dropdown-item d-flex justify-content-between align-items-center mb-2" style="max-width: 400px; overflow-x: hidden;">
              <a href=" #" class="text-decoration-none text-secondary">
                <div class="row">
                  <div class="col-md-2">
                    <img class="img-thumbnail" src="assets/images/fashion.jpg" alt="" style="max-width: 50px;" class="me-4">
                  </div>
                  <div class="col-md-8 text-wrap">
                    Pants and smartphone laptop adfsafafafvfdavdaavd
                  </div>
                  <div class="col-md-2 d-flex">
                    <h5 class="text-dark fw-5 fs-6 align-items-center">$14.00</h5>
                  </div>
                </div>
              </a>
            </li>
            <li class="dropdown-item d-flex justify-content-between align-items-center mb-2" style="max-width: 400px; overflow-x: hidden;">
              <a href=" #" class="text-decoration-none text-secondary">
                <div class="row">
                  <div class="col-md-2">
                    <img src="assets/images/fashion.jpg" alt="" style="max-width: 50px;" class="me-4">
                  </div>
                  <div class="col-md-8 text-wrap">
                    Pants and smartphone laptop adfsafafafvfdavdaavd
                  </div>
